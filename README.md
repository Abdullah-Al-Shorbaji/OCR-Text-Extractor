...
[![Downloads](https://poser.pugx.org/ShababSoftwares/OCR-Text-Extractor/d/total.svg)](https://github.com/abdullah-al-shorbaji/OCR-Text-Extractor)
...
```bash
composer create-project abdullah-al-shorbaji/ocr-text-extractor
```
